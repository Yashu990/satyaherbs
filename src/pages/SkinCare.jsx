...
import heroImg from '../images /hero_skin_care.png'
  ...
  const products = [
    {
      ...
      rating: 4.9,
      reviews: 5621,
      description: 'Boost collagen, reduce blemishes, and restore youthful radiance with our mineral-rich natural formula.',
      features: ['Collagen Boost', 'Anti-Aging', 'Blemish-Free', 'Natural Glow'],
      badge: 'Best Seller',
      img: prod1
    },
    {
      ...
      rating: 4.8,
      reviews: 3847,
      description: 'Reduces fine lines, improves skin elasticity, and restores youthful texture. Dermatologist approved.',
      features: ['Fine Line Reduction', 'Elasticity Boost', 'Cell Renewal', 'Dermat Approved'],
      badge: 'Top Rated',
      img: prod2
    },
    {
      id: 3,
      name: 'Skin Wellness Bundle',
      price: '₹4,499',
      originalPrice: '₹6,999',
      rating: 4.9,
      reviews: 6103,
      description: 'Complete inside-out skin transformation kit for radiant, clear, and smooth skin in 30 days.',
      features: ['3 Products', 'Inside-Out Glow', 'Dermat Tested', 'Free Shipping'],
      badge: 'Best Value',
      img: prod3
    }
  ]
  const stats = [
    { value: '95%', label: 'Saw Improvement' },
    { value: '89%', label: 'Reduced Blemishes' },
    { value: '30 Days', label: 'To Results' },
    { value: '4.9★', label: 'Average Rating' }
  ]
  const benefits = [
    { icon: '✨', title: 'Inner Glow', desc: 'Minerals for lasting radiance from within' },
    { icon: '🔬', title: 'Clinically Proven', desc: 'Dermatologist-tested, clinically verified' },
    { icon: '🌿', title: '100% Natural', desc: 'No harsh chemicals, no synthetic additives' },
    { icon: '🛡️', title: 'Skin Barrier', desc: 'Strengthen and protect your skin' }
  ]
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="relative w-full overflow-hidden" style={{ minHeight: '560px' }}>
        ...
        <div className="absolute inset-0" style={{ background: 'linear-gradient(90deg, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.55) 60%, rgba(0,0,0,0.15) 100%)' }}></div>
        <div className="relative z-10 flex flex-col justify-center px-8 md:px-20" style={{ paddingTop: '120px', paddingBottom: '60px' }}>
          <div className="max-w-2xl">
            <span className="inline-block px-4 py-1 rounded-full text-xs font-semibold tracking-widest uppercase mb-4" style={{ background: 'rgba(200,164,90,0.2)', color: '#c8a45a', border: '1px solid rgba(200,164,90,0.5)' }}>
              ✨ Trusted by 5 Lakh+ Skin Lovers
            </span>
            <h1 className="font-serif font-bold text-white mb-4" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: '1.1' }}>
              Skin <span style={{ color: '#c8a45a' }}>Care</span>
            </h1>
            <p className="text-lg mb-8" style={{ color: '#e0e0e0', maxWidth: '520px' }}>
              Radiant, youthful skin from within — powered by nature's finest minerals and ancient Ayurvedic wisdom
            </p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h2 className="font-serif font-bold text-black mb-3" style={{ fontSize: '2rem' }}>Natural Skin Beauty Products</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">Achieve glowing, radiant skin naturally. Our formulations work from within to boost collagen, reduce blemishes, and improve skin elasticity.</p>
        </div>
          ...
          {products.map((product) => (
            <div key={product.id} className="rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-white border border-gray-100">
              ...
              <div className="p-6">
                ...
                <button className="w-full py-3 rounded-xl font-bold text-white transition-all hover:opacity-90" style={{ background: 'linear-gradient(135deg, #100308, #200515)' }}>Add to Cart</button>
              </div>
            </div>
          ))}
        </div>
        <div className="mb-16">
          <h3 className="font-serif font-bold text-center text-black mb-8 text-2xl">Why Your Skin Deserves the Best?</h3>
        ...
        <div className="rounded-2xl p-10 text-center text-white" style={{ background: 'linear-gradient(135deg, #100308, #200515)' }}>
          <h3 className="font-serif font-bold text-3xl mb-3">Reveal Your Most Radiant Skin</h3>
          <p className="text-lg mb-6" style={{ color: '#d0d0d0' }}>500,000+ customers with glowing results. Clinically proven, dermatologist-approved. 30-day guarantee.</p>
          <button className="px-10 py-4 rounded-xl font-bold text-black text-lg transition-all hover:scale-105" style={{ background: 'linear-gradient(135deg, #c8a45a, #e8c87a)' }}>Shop Skin Care →</button>
        </div>
      </div>
    </div>
  )
